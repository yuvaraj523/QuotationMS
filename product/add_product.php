        ...
        <?php } ?>
                ...
                <div class="form-row">
                    ...
                    <select id="productCategory" name="productCategory" required>
                        ...
                        <option value="flowmore">Flowmore Water Pumps</option>
                        <option value="submersible">Borewell Submersible Pumps</option>
                        <option value="cri">CRI Water Pumps</option>
                        <option value="centrifugal">Centrifugal Pumps</option>
                        <option value="general">Water Pump</option>
                    </select>
                </div>
