                ...
                <div class="card">
                    <div class="form-row">
                        ...
                        <select id="productCategory" name="productCategory" required>
                            ...
                            <option value="flowmore" <?php if($currentProductCategory == 'flowmore') echo 'selected'; ?>>Flowmore Water Pumps</option>
                            <option value="submersible" <?php if($currentProductCategory == 'submersible') echo 'selected'; ?>>Borewell Submersible Pumps</option>
                            <option value="cri" <?php if($currentProductCategory == 'cri') echo 'selected'; ?>>CRI Water Pumps</option>
                            <option value="centrifugal" <?php if($currentProductCategory == 'centrifugal') echo 'selected'; ?>>Centrifugal Pumps</option>
                            <option value="general" <?php if($currentProductCategory == 'general') echo 'selected'; ?>>Water Pump</option>
                        </select><br><br>
                    </div>
                </div>
